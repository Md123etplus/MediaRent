...
Route::prefix('partenaire')->name('partenaire.')->group(function () {
    ...
    Route::get('/livraisons', [PartenaireDashboardController::class, 'livraisons'])->name('livraisons');
    Route::post('/livraisons/{id}/repondre/{reponse}', [PartenaireDashboardController::class, 'repondreLivraison'])->name('livraisons.repondre');
    Route::get('/livraisons/{id}/details', [PartenaireDashboardController::class, 'livraisonDetails'])->name('livraisons.details'); // Nouvelle route
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get(
        '/annonces/{annonce}/payment-success/{reference}',
