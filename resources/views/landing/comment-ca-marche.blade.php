...
<div class="container mx-auto px-4">
    ...
    <p class="text-xl text-center text-gray-600 dark:text-gray-300 mb-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- Step 1 -->
        <div class="flex flex-col items-center text-center p-6 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 transition">
            <div class="w-16 h-16 rounded-full bg-blue-500 flex items-center justify-center text-white text-2xl font-bold mb-4">
                1
            </div>
            <h3 class="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Créez votre compte</h3>
        ...
        <div class="flex flex-col items-center text-center p-6 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 transition">
            ...
            <h3 class="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Trouvez ou proposez du matériel</h3>
            <p class="text-gray-600 dark:text-gray-300">
        ...
        <div class="flex flex-col items-center text-center p-6 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 transition">
            ...
            <h3 class="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Réservez et profitez</h3>
            <p class="text-gray-600 dark:text-gray-300">
