    ...
    <div class="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="w-64 sidebar">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('partenaire.livraisons') }}" class="nav-item">
            ...
            <main class="container mx-auto px-4 py-8">
                ...
                <section class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- Revenue Card -->
                        <div
                            class="bg-gradient-to-br from-green-50 to-green-100 p-5 rounded-lg shadow hover:shadow-md transition-shadow">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-sm font-medium text-gray-600">Revenu Total</p>
                                    <p class="text-3xl font-bold text-green-700 mt-1">{{ number_format($revenuTotal, 2) }}
                                        DH</p>
                                </div>
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <a href="{{ route('partenaire.reservations') }}"
                        ...
                        <div
                            class="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-lg shadow hover:shadow-md transition-shadow">
                            <div class="flex justify-between items-start">
                                <div>
                            ...
                            <div class="mt-4">
                                <div class="w-full bg-blue-200 rounded-full h-2">
                                    <div class="bg-blue-600 h-2 rounded-full"
                                        style="width: {{ $totalAnnonces ? round(($annoncesActives / $totalAnnonces) * 100, 2) : 0 }}%%">
                                    </div>
                                </div>
                                <p class="text-xs text-blue-600 mt-1 text-right">
                                    {{ $annoncesActives . '/' . $totalAnnonces . ($totalAnnonces > 0 ? ' (' . round(($annoncesActives / $totalAnnonces) * 100, 2) . '%)' : '') }}
                                    annonces</p>
                            </div>
                        </div>
                        ...
                        <!-- Occupancy Rate Card -->
                        <div
                            class="bg-gradient-to-br from-purple-50 to-purple-100 p-5 rounded-lg shadow hover:shadow-md transition-shadow">
                            <div class="flex justify-between items-start">
                                <div>
                            ...
                            <div class="mt-4">
                                <div class="w-full bg-purple-200 rounded-full h-2">
                                    <div class="bg-purple-600 h-2 rounded-full" style="width: {{ $tauxOccupation }}%">
                                    </div>
                                </div>
                                <p class="text-xs text-purple-600 mt-1 text-right">
                                    {{ $joursOccupes }}/{{ $joursDisponibles }} jours</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="glass-card rounded-2xl shadow-lg overflow-hidden">
                        <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-white">
                            ...
                            <div class="flex space-x-3">
                                <button id="refresh-archives"
                                    class="btn-primary flex items-center space-x-2 px-4 py-2 text-sm rounded-lg">
                        ...
                        <div class="p-6 bg-gray-50">
                            @forelse($annoncesArchives as $annonce)
                                <div class="archive-item mb-4">
                                    <div
                                        class="archive-card bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md">
                                        <div class="p-5 flex flex-col md:flex-row md:items-center justify-between">
                                            <div class="flex items-start space-x-4">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <h3 class="text-lg font-semibold text-gray-800 truncate">
                                                        {{ $annonce->objet->nom }}</h3>
                                                    <div class="mt-2 flex flex-wrap gap-3 text-sm">
                                                        <span
                                                            class="flex items-center text-gray-500 bg-gray-100 px-2 py-1 rounded-full">
                                            ...
                                            <div class="mt-4 md:mt-0 flex space-x-2">
                                                <form method="POST"
                                                    action="{{ route('partenaire.annonce.restore', $annonce->id) }}">
                                                    @csrf
                                                    @method('PUT')
                                                    <button type="submit"
                            ...
                            @empty
                                <div class="text-center py-12">
                                    ...
                                    <p class="text-gray-500 mt-2 max-w-md mx-auto">
                                        Vos annonces archivées apparaîtront ici. Les archives conservent vos annonces
                                        pendant 6 mois.
                                    </p>
                                </div>
                            @endforelse
                    ...
                    try {
                        const response = await fetch(form.action, {
                            ...
                            body: JSON.stringify({
                                ...
                                date_debut: form.querySelector('[name="date_debut"]')
                                    .value,
