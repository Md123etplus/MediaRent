...
<div class="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
  ...
  <div class="w-64 sidebar">
    ...
    <nav class="mt-6">
      ...
      <a href="{{ route('partenaire.objets.index') }}" class="nav-item">
    ...
    <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-lg shadow hover:shadow-md transition-shadow">
      ...
      <div class="mt-4">
        <div class="w-full bg-blue-200 rounded-full h-2">
          <div class="bg-blue-600 h-2 rounded-full" style="width: {{ ($annoncesActives/$totalAnnonces)*100 }}%"></div>
        </div>
        <p class="text-xs text-blue-600 mt-1 text-right">{{ $annoncesActives }}/{{ $totalAnnonces }} annonces</p>
      </div>
    </div>
