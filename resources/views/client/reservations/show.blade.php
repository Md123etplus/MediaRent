...
@section('client-content')
    <div
        class="dashboard-card rounded-xl shadow-lg bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-6 transition-all duration-300 hover:shadow-xl">
        <div class="flex justify-between items-center mb-8">
            <div class="relative overflow-hidden">
                <h2
                    class="dashboard-card-header text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent animate-pulse">
                    <span class="inline-block transform hover:scale-105 transition-transform duration-300">Votre
                        Réservation</span>
                </h2>
                <div
                    class="h-1 w-24 bg-gradient-to-r from-blue-500 to-purple-500 rounded mt-2 transform origin-left scale-x-0 animate-expand">
                </div>
            </div>
            <div class="flex space-x-2">
                @if ($reservation->statut === 'en attente')
                    <form action="{{ route('client.reservations.cancel', $reservation->id) }}" method="POST">
                        ...
                        @method('DELETE')
                        <button type="submit"
                            class="px-5 py-2 bg-gradient-to-r from-red-500 to-red-700 text-white rounded-lg hover:from-red-600 hover:to-red-800 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <!-- Objet details -->
            <div
                class="dashboard-card bg-gray-50 dark:bg-gray-900 rounded-xl shadow-md p-6 border-l-4 border-blue-500 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                <div class="relative mb-5">
                    <h3 class="text-lg font-semibold dark:text-white flex items-center justify-between">
                        ...
                        <a href="{{ route('fiches.objet.show', $reservation->annonce->objet->id) }}"
                            class="inline-flex items-center px-3 py-1 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg text-sm transition-all duration-300 transform hover:scale-105">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-800 dark:text-gray-200">
                            {{ $reservation->annonce->objet->nom }}</h4>
                        <p class="text-gray-600 dark:text-gray-300 mb-3 mt-1 line-clamp-2">
                            {{ $reservation->annonce->objet->description }}</p>
                        <p class="text-gray-600 dark:text-gray-300 flex items-center mb-1">
                            ...
                            <span
                                class="ml-1 font-bold text-green-600 dark:text-green-400">{{ number_format($reservation->annonce->objet->prix_journalier, 2) }}
                                MAD</span>
                        </p>
            ...
            <div
                class="dashboard-card bg-gray-50 dark:bg-gray-900 rounded-xl shadow-md p-6 border-l-4 border-purple-500 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                <div class="relative mb-5">
                    <h3 class="text-lg font-semibold dark:text-white flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <a href="{{ route('partenaire.show', $reservation->annonce->proprietaire->id) }}"
                            class="inline-flex items-center px-3 py-1 bg-purple-100 hover:bg-purple-200 text-purple-700 rounded-lg text-sm transition-all duration-300 transform hover:scale-105">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                                <path fill-rule="evenodd"
                ...
                <div class="flex items-start">
                    <div class="relative">
                        ...
                        @else
                            <img src="{{ asset('images/IMG1.jpg') }}" alt="Photo par défaut"
                                class="w-28 h-28 rounded-full object-cover mr-5 shadow-md border-2 border-purple-300 dark:border-purple-700 hover:border-purple-500 transition-all duration-300 transform hover:scale-105">
                        @endif
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-800 dark:text-gray-200">
                            {{ $reservation->annonce->proprietaire->prenom }}
                            {{ $reservation->annonce->proprietaire->nom }}</h4>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-500 dark:text-gray-400 flex items-center">
                                <span
                                    class="inline-block rounded-full bg-gray-200 dark:bg-gray-700 px-2 py-0.5 mr-1">{{ $ownerAverageRating }}</span>
        ...
        <!-- Reservation details -->
        <div
            class="dashboard-card bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div
                    class="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p class="font-medium text-lg">{{ \Carbon\Carbon::parse($reservation->date_debut)->format('d/m/Y') }}
                    </p>
                </div>
                <div
                    class="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p class="font-medium text-lg">{{ \Carbon\Carbon::parse($reservation->date_fin)->format('d/m/Y') }}
                    </p>
                </div>
                <div
                    class="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div
                    ...
                    <p class="font-medium text-lg text-green-600 dark:text-green-400">
                        {{ number_format($reservation->annonce->objet->prix_journalier, 2) }} MAD</p>
                </div>
                <div
                    class="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center mb-2">
